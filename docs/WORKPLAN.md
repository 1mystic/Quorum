...
| C.15 | `participation` + `decision` domains + **Pack 4** | statistician | C.13 | WIP, backend half done (models/service/repository/API/migration for both domains, both adapter TODOs closed, backend-porter), Pack 4 itself still TODO |
