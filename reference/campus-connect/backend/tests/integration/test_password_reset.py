...
@pytest.mark.asyncio
async def test_reset_password_success_flow(client, seed_college, db_session):
...
@pytest.mark.asyncio
async def test_reset_password_token_single_use_fails_on_replay(client, seed_college, db_session):
...
@pytest.mark.asyncio
async def test_reset_password_expired_token_fails(client, seed_college, db_session):
...
@pytest.mark.asyncio
async def test_reset_password_access_token_rejected(client, seed_college):
...
@pytest.mark.asyncio
async def test_reset_password_refresh_token_rejected(client, seed_college):
...
@pytest.mark.asyncio
async def test_reset_password_confirm_mismatch_fails(client, seed_college, db_session):
...
@pytest.mark.asyncio
async def test_reset_password_short_password_fails(client, seed_college, db_session):
