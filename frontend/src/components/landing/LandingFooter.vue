    ...
    <div class="wrap">
      <div class="foot">
        <div>
          ...
          <p>Enough people to decide. Enough data to conclude.</p>
        </div>
        <div>
          <h4>Product</h4>
          <ul>
      ...
      <div class="colophon">
        <span>Quorum, community operations, statistically honest</span>
        <span>bricolage grotesque, inter tight, jetbrains mono</span>
      </div>
    </div>
  </footer>
</template>
