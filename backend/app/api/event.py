...
async def browse_events(
    status: EventStatus | None = Query(None, description="Campus admins, and a group leader who also passes their own group_id, get the status they ask for; everyone else always gets PUBLISHED events"),
    ...
    return await service.list(payload, status=status, group_id=group_id, search=search,
